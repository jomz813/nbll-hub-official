...
export const hallOfFameMembers: HOFMember[] = [
  { 
    ...
    description: "Pansho is one of the most prolific scorers in BL history. His five rings are more than any other player’s. his 2,250+ career points rank him 8th on the all-time scoring list. Pansho is arguably the greatest to ever touch the game. (I’m glazing)."
  },
  { 
    name: 'Tend',
    image: '/hof/tend.gif',
